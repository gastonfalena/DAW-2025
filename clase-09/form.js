document.addEventListener('DOMContentLoaded', function() { // Se puede evitar DOMContentLoaded porque el script esta al final del body
    ...
    fullnameInput.addEventListener('keyup', updateTitle); // Se dispara cuando la tecla se suelta
  ...
  var inputs = document.querySelectorAll('input');
    ...
    form.addEventListener('submit', function(e) {
        e.preventDefault(); // evita el comportamiento por defecto y permite validar nuestros campos antes de enviarlos
